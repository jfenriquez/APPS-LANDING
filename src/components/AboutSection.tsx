...
const AboutSection = () => {
  return (
    <section className="py-12 px-6 sm:px-8 md:px-12  text-center md:text-left text-black ">
      <h2
        className="text-2xl sm:text-3xl md:text-4xl font-bold mb-6 backdrop-blur-lg   "
        style={{ textShadow: "3px 3px 15px rgb(255, 255, 255)" }}
      >
        Sobre Nosotros
      </h2>
      <p
        className="text-base sm:text-lg md:text-xl max-w-4xl mx-auto md:mx-0 leading-relaxed"
        style={{ textShadow: "3px 3px 15px rgb(255, 255, 255)" }}
      >
